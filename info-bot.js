...
await conn.sendMessage(m.chat, {text: loadd[i], edit: key })}
  ...
  let mentionedJid = [m.sender]
    ...
    let sts = ` – *ɪɴғᴏ ʙᴏᴛ ɪɴᴢɪᴇ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ*
...
seconds: 18,
fileLength: 18,
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ɪɴᴢɪᴇ ᴏғᴄ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: 'ʙᴏᴛ ʙʏ ɪɴᴢɪᴇ', sourceUrl: 'https://whatsapp.com/channel/0029Vajc7fkBA1erCyF48I3k', thumbnail: await (await fetch(thumb)).buffer(),}}  
  }) 
}
